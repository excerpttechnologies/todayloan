...
// Sub-schema for a Sales Manager assigned to a bank assignment by the connector
const assignedSMSchema = new Schema(
  {
    smId: { type: Schema.Types.ObjectId, required: true }, // matches Bank.salesManagers[].smId
    name: { type: String, default: "" },
    email: { type: String, default: "" },
  },
  { _id: false }
...
const bankAssignmentSchema = new Schema(
  {
    ...
    // Sales Manager(s) the connector chose for this bank at submission time
    assignedSMs: { type: [assignedSMSchema], default: [] },
...
const incomeDetailsSchema = new Schema(
  {
    ...
    companyCategory: { type: String, default: "A" },

    netSalaryMonth1: { type: Number, default: 0 },
    netSalaryMonth1Period: { type: String, default: "" }, // "YYYY-MM", e.g. "2026-07"
    netSalaryMonth2: { type: Number, default: 0 },
    netSalaryMonth2Period: { type: String, default: "" },
    netSalaryMonth3: { type: Number, default: 0 },
    netSalaryMonth3Period: { type: String, default: "" },

    grossSalary: { type: Number, default: 0 },
    salaryMode: { type: String, default: "Account Transfer" },
    designation: { type: String, default: "" },
    doj: { type: String, default: "" },
    totalExperience: { type: String, default: "" },
    firmName: { type: String, default: "" },
    companyType: { type: String, default: "Proprietorship" },
    natureOfBusiness: { type: String, default: "" },
    businessVintage: { type: String, default: "" },
  },
  { _id: false }
);
...
const loanApplicationSchema = new Schema(
  {
    ...
    // Every bank the connector pushed this lead to, with its own
    // independent status/interest/unmask/assignedSMs state.
    bankAssignments: [bankAssignmentSchema],
